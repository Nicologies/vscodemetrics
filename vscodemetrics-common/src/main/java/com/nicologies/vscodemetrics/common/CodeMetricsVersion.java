...
public enum CodeMetricsVersion {
  ...
  not_specified("not_specified", "Any Detected") {
    ...
    public Requirement createRequirement() {
      return new Requirement(SettingsKeys.CmdFileVersionProperty, null, RequirementType.EXISTS);
    }
  },
  v12_0("12.0", "12.0"),
  v14_0("14.0", "14.0");
  ...
  @Nullable
  public Requirement createRequirement(){
    return new Requirement(SettingsKeys.CmdFileVersionProperty, getTechnicalVersionPrefix(), RequirementType.STARTS_WITH);
  }
}
